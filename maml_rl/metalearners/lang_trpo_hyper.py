...
class MAMLTRPO(GradientBasedMetaLearner):
    ...
    def adapt_one(self, mission):
        ...
        if constraint_text is not None and self.hypernetwork is not None:
        ...
        # Construct Absolute Hypernetwork Parameter Array
        if self.hypernetwork is not None:
            ...
            theta_prime_tensors = self.hypernetwork(combined_input)
    ...
    def step(self,
        ...
        if self.hypernetwork is not None:
            meta_params += list(self.hypernetwork.parameters())
